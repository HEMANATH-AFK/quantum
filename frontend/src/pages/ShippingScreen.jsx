  ...
  return (
    <FormContainer>
      <FadeIn duration={0.4}>
        ...
        <h1 className="text-3xl font-black text-gray-900 dark:text-white mb-8">Shipping</h1>
        ...
        {isLoading ? (
          ...
          <div className="mb-8">
              <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-4">Saved Addresses</h2>
              <div className="grid gap-4 md:grid-cols-2">
                  {profile.addresses.map((addr) => (
                      ...
                      >
                          <p className="font-medium text-gray-900 dark:text-white">{addr.address}</p>
                          <p className="text-sm text-gray-500 dark:text-gray-400">{addr.city}, {addr.postalCode}</p>
                          <p className="text-sm text-gray-500 dark:text-gray-400">{addr.country}</p>
                      </div>
                  ))}
              </div>
              <div className="relative flex py-6 items-center">
                  <div className="flex-grow border-t border-gray-200 dark:border-gray-750"></div>
                  <span className="flex-shrink-0 mx-4 text-gray-400 dark:text-gray-500 text-sm font-bold uppercase">Or enter new address</span>
                  <div className="flex-grow border-t border-gray-200 dark:border-gray-750"></div>
              </div>
          </div>
        ) : null}
        ...
        <form onSubmit={submitHandler} className="space-y-6">
          ...
          <div className="flex items-center space-x-2 py-2">
              ...
              />
              <label htmlFor="saveAddress" className="text-sm text-gray-700 dark:text-gray-300 font-medium cursor-pointer">
          ...
          <div className="flex">
            <ShinyButton 
                type="submit" 
                className="w-full btn-primary py-4 font-black flex justify-center items-center rounded-2xl cursor-pointer"
